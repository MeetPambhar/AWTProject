...
interface NavbarProps {
    user?: any; // Using any for payload, ideally should import SessionPayload type
}
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-border">
                    <div className="text-right hidden sm:block">
                        <p className="text-sm font-medium text-foreground capitalize">{user?.name || 'Guest'}</p>
                        <p className="text-xs text-muted-foreground uppercase">{user?.role || 'User'}</p>
                    </div>
